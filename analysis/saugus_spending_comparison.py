...
Produces Reports/saugus_spending_vs_peers.pdf with:
...
Run: python analysis/saugus_spending_comparison.py
"""
import sys, os
...
OUTPUT_PDF = os.path.join(OUTPUT_DIR, "saugus_spending_vs_peers.pdf")
