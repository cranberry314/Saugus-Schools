...
The project's fixed-peer benchmarking uses each town's **2011–2014 baseline** —
...
The 15 towns closest to Saugus in this 8-dimensional space become Saugus's fixed
peer group. Towns missing baseline data for any factor drop out of the comparison
pool naturally.
